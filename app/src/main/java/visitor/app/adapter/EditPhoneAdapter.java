...
/**
 * @class: EditPhoneAdapter
 * @desc: This Adapter class is for handling multiple phones on EditActivity.
 */

public class EditPhoneAdapter extends ArrayAdapter<String> {
    ...
    public EditPhoneAdapter(Activity activity, Context context, View.OnClickListener event, ArrayList<String> holder) {
